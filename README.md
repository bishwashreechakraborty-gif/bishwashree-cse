...
# Hey, I'm Bishwashree Chakraborty 👋
...
- 🎓 **B.Tech Computer Science Engineering** at Barak Valley Engineering College, Assam
- 🧠 Summer Intern at **IIT Guwahati** — MRI Brain Tumor Classification & Segmentation
- 👁️ Passionate about **AI/ML**, **Computer Vision** & **Deep Learning**
- 🔭 Currently working on intelligent software that solves real-world problems
- 📫 Reach me at **bishwashreechakraborty@gmail.com**
...
|---------|-------------|------|
| 🧥 [**AI Invisible Cloak**](https://github.com/bishwashreechakraborty-gif/AI-Invisible-Cloak) | Real-time invisibility effect using Computer Vision | Python, OpenCV |
| 🧠 **MRI Brain Tumor Detection** | Deep Learning model to classify brain tumors from MRI scans | Python, TensorFlow |
| 🍽️ **FoodScan** | Food scanning & nutritional analysis application | React, Node.js |
| 🎓 **Student Admission Portal** | Desktop application for streamlined university admissions | Java, MySQL |
| ✍️ **Digit Recognition** | Handwritten digit recognition built from scratch, no ML libraries | Python, Math |

---

### 📜 Certifications

- 🏅 **Brain Tumor MRI Segmentation** — Technology Innovation Hub, IIT Guwahati
- 📊 **Data Analysis with Python** — IBM
- 🤖 **Claude AI: From Basics to Build** — PhysicsWallah
- 🧬 **Generative AI for All** — PhysicsWallah
